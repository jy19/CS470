...
class WeightedDirectedGraph:
    ...
    def aStarSearch(self, start, goal):
        ...
        while len(frontier) > 0:
            ...
            print 'Creating map...'
            map_create("{1}_astar_{0:04}".format(i, image_group), self.graph, map(lambda x: x[2], frontier), visited, came_from, start,
                       current, goal)
            print '...done.'
    ...
    def breadthFirstSearch(self, start, goal):
        ...
        while len(frontier) > 0:
            ...
            for target, weight in self.graph[current]:
                ...
                map_create("{1}_bfs_{0:04}".format(i, image_group), self.graph, map(lambda x: x[0], frontier), visited, came_from, start,
                           target, goal)
    ...
    def depth_first_search(self, start, goal):
        ...
        while frontier:
            ...
            for next, weight in self.graph[current]:
                ...
                map_create("{1}_dfs_{0:04}".format(i, image_group), self.graph, map(lambda x: x[0], frontier), visited, came_from, start,
                           next, goal)
